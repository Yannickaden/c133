...
function preload()
{
    img = loadImage("Car_Controller.jpeg");
}
function setup()
{
...
function draw()
{
    ...
    if(CocossdModelStatus == "True")
    {
        for(i=0;i<objects.length;i++)
        {
            ...
            document.getElementById("NumberOFObjects").innerHTML = "There are 2 objects in the image from which cocossd model has detected "+objects.length+" object.";
            fill("white");
